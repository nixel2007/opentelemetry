...
При невалидном заголовке возвращает исходный контекст без изменений. Невалидным считается заголовок,
в котором версия, trace-id, parent-id или флаги имеют неверную длину или содержат что-то кроме
строчных hex-символов (W3C допускает только `0-9a-f`), а также заголовок с нулевыми идентификаторами
или версией `ff`.
